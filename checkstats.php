...
<div id="center">
	<div class="boxed">
		...
		{
			echo'
			<h1>Search User Stats</h1><br>
			<form action="showstats.php" method="post">
			<input name="search" type="hidden" value="single">
			Name<br><input name="user1" type="text" maxlength="24">
		...
		{
			echo'
			<h1>Compare User Stats</h1><br>
			<form action="showstats.php" method="post">
			<input name="search" type="hidden" value="double">
			First Name<br><input name="user1" type="text" maxlength="24">
			<br>Second Name<br><input name="user2" type="text" maxlength="24">
			<br><input name="submit" type="submit" value="   submit   ">
			</form>';
		}
